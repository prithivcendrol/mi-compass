...
public class AlertDialogLayout extends C0364o0 {
    public AlertDialogLayout(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
    }

    /* renamed from: h */
    private void m1116h(int i, int i2) {
        int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(getMeasuredWidth(), 1073741824);
        for (int i3 = 0; i3 < i; i3++) {
            View childAt = getChildAt(i3);
            if (childAt.getVisibility() != 8) {
                C0364o0.C0365a aVar = (C0364o0.C0365a) childAt.getLayoutParams();
                if (aVar.width == -1) {
                    int i4 = aVar.height;
    ...
    /* renamed from: w */
    private void m1117w(View view, int i, int i2, int i3, int i4) {
        view.layout(i, i2, i3 + i, i4 + i2);
    }

    /* renamed from: x */
    private static int m1118x(View view) {
        int v = C0727l0.m2917v(view);
        if (v > 0) {
            return v;
        }
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return m1118x(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }
    ...
    /* renamed from: y */
    private boolean m1119y(int i, int i2) {
        int i3;
        int i4;
        int i5;
        int i6;
        ...
        for (int i9 = 0; i9 < childCount; i9++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == C1452f.f5785P) {
                    view = childAt;
                } else if (id == C1452f.f5796k) {
                    view2 = childAt;
                } else if ((id != C1452f.f5798m && id != C1452f.f5800o) || view3 != null) {
                    return false;
                } else {
                    view3 = childAt;
                }
    ...
    public void onLayout(boolean r18, int r19, int r20, int r21, int r22) {
        ...
        L_0x005a:
            ...
            r15 = r2
            androidx.appcompat.widget.o0$a r15 = (androidx.appcompat.widget.C0364o0.C0365a) r15
            int r2 = r15.gravity
            if (r2 >= 0) goto L_0x007e
            r2 = r11
        L_0x007e:
            int r3 = androidx.core.view.C0727l0.m2916u(r17)
            int r2 = androidx.core.view.C0681e.m2704a(r2, r3)
            r2 = r2 & 7
            r3 = 1
