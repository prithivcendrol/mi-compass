...
public class SlidingSwitch extends Switch {
    ...
    public SlidingSwitch(Context context, AttributeSet attributeSet, int i) {
        ...
        this.f9200d.mo5784v(context, obtainStyledAttributes);
    ...
    public void onMeasure(int i, int i2) {
        setMeasuredDimension(this.f9200d.mo5780q(), this.f9200d.mo5779p());
        this.f9200d.mo5774P();
    }
    ...
    public boolean verifyDrawable(android.graphics.drawable.Drawable r2) {
        ...
        L_0x0014:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: miuix.slidingwidget.widget.SlidingSwitch.verifyDrawable(android.graphics.drawable.Drawable):boolean");
    }
}
