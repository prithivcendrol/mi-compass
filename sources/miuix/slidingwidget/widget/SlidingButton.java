...
public class SlidingButton extends AppCompatCheckBox {
    ...
    public SlidingButton(Context context, AttributeSet attributeSet, int i) {
        ...
        this.f9199h.mo5784v(context, obtainStyledAttributes);
    ...
    public void onMeasure(int i, int i2) {
        setMeasuredDimension(this.f9199h.mo5780q(), this.f9199h.mo5779p());
        this.f9199h.mo5774P();
    }
