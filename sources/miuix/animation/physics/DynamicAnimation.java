...
public abstract class DynamicAnimation<T extends DynamicAnimation<T>> implements AnimationHandler.AnimationFrameCallback {
    ...
    <K> DynamicAnimation(K k, FloatProperty<K> floatProperty) {
        ...
        this.mMinVisibleChange = (floatProperty == ViewProperty.ROTATION || floatProperty == ViewProperty.ROTATION_X || floatProperty == ViewProperty.ROTATION_Y) ? 0.1f : floatProperty == ViewProperty.ALPHA ? 0.00390625f : (floatProperty == ViewProperty.SCALE_X || floatProperty == ViewProperty.SCALE_Y) ? 0.002f : 1.0f;
    }
